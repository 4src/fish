...
function NUM.new(i,n,s) 
  i.name=s or ""; i.at=n or 0; i.n=0; i.lo=l.big; i.hi= -l.big; i.mu=0; i.m2=0 
  i.pretty = "%.0f"
...
then the = l.settings(the,help, l.cli); l.main(help, the)
else the = l.settings(the,help); return {NUM=NUM, SYM=SYM}
end
