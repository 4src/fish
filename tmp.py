...
##!./mydown
# # vim: set filetype=python et sts=3 sw=3 ts=3 :
# Copyright 1995, Prentice-Hall.)

#Introduction

#John McCarthy and his students began work on the first Lisp implementation in
# 1958.  After Fortran, Lisp is the oldest language still in use. [1] What is more
# remarkable is that it is still in the forefront of programming language
# technology.  Programmers who know Lisp will tell you, there is something about
# this language that sets it apart.
...
#Why learn Lisp? Because it lets you do things that you can nott do in
...
#If you only need to do such simple things, it does not really matter
